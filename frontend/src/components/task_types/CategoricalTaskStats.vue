...
<div class="task-stats">
    ...
    <div v-if="stats">
        ...
        <div v-if="stats" class="barchart-container">
            ...
            <BarChart :data="getBarChartData(stats.annotation_distribution)" :options="barchart_options"/>
            <div
                v-for="annotator_distribution in stats.per_annotator_distributions"
                :key="annotator_distribution[0].annotator_last_name"
            >
                <h5>Annotated by: {{annotator_distribution[0].annotator_first_name}} {{annotator_distribution[0].annotator_last_name}}</h5>
                <BarChart :data="getBarChartData(annotator_distribution)" :options="barchart_options"/>
            </div>
        </div>
    </div>
</div>
