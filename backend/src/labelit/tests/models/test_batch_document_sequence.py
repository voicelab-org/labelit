...
class BatchDocumentSequenceModelTests(TestCase):
    ...
    def test_update_annotation_progress_statistics(self):
        ...
        self.assertEqual(
            self.batch_unit.num_done_annotators, 0
        )  # still 0, only one doc annotated
        self.assertEqual(self.batch_unit.num_annotators, 1)
        with temp_disconnect_signal(**signal_disconnect_kwargs):
        ...
        self.assertEqual(self.batch_unit.num_done_annotators, 1)

    def test_update_annotation_progress_statistics_with_two_tasks_and_two_annotators(
        self,
    ):
        ...
        self.assertEqual(self.batch_unit.num_done_annotators, 1)
        self.assertEqual(self.batch_unit.num_annotators, 2)
        with temp_disconnect_signal(**signal_disconnect_kwargs):
        ...
        self.assertEqual(self.batch_unit.num_done_annotators, 2)
