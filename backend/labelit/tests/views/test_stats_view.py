...
class StatsViewTests(TestSetup, TestCase):
    ...
    def test_view_returns_correct_data(self):
        ...
        self.assertEqual(response.data['stats_per_annotator'][0]['annotator__first_name'], "eric")
        ...
        try:
            ...
            self.assertTrue(False)
        self.assertEqual(response.data['stats_per_annotator'][0]['total_duration'], 30000)
