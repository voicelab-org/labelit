    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transcript', models.TextField(blank=True, default='', verbose_name='the transcript')),
                ('timed_transcript_segment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='labelit.timedtranscriptsegment')),
            ],
            bases=('labelit.label',),
        ),
    ]
