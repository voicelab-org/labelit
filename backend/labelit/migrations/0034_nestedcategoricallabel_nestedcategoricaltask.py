    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('single_select', models.BooleanField(default=True, verbose_name='\n        If true, the annotator cannot select more than one label.\n        ')),
            ],
            bases=('labelit.task',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('single_child_select', models.BooleanField(default=True, verbose_name='Whether only one child label can be selected at any time')),
                ('parent_label', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nested_children_labels', to='labelit.label')),
            ],
            bases=('labelit.label',),
        ),
    ]
