...
router.register(r'projects_with_stats', views.ProjectWithStatsViewSet, basename='projects_with_stats')
...
urlpatterns = [
    ...
    path('download_image/<str:filename>/', views.ImageDownload.as_view(), name="download_image_view"),
