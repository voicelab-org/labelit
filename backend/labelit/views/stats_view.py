...
from labelit.models.completed_document_annotator_pair import CompletedDocumentAnnotatorPair
...
class StatsView(APIView):
    ...
    def get(self, request):
        def _get_stats(
            ...
            completed_document_annotator_pairs = CompletedDocumentAnnotatorPair.objects.filter(
                created_at__gte=min_date,
                created_at__lte=max_date,
            )

            if len(projects):
                completed_document_annotator_pairs = completed_document_annotator_pairs.filter(
            ...
            total_duration = completed_document_annotator_pairs.aggregate(total=Sum(F('document__audio_duration')))['total']
            ...
            completed_document_annotator_pairs_per_day = completed_document_annotator_pairs.annotate(
